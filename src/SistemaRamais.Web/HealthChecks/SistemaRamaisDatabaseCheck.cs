...
public class SistemaRamaisDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SistemaRamaisDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
