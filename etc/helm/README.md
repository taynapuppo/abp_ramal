...
```
127.0.0.1 sistemaramais-local-web
127.0.0.1 sistemaramais-local-webgateway
127.0.0.1 sistemaramais-local-authserver
```
...
Now, you can browse the URL: `https://sistemaramais-local-web`
