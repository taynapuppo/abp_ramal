...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9a66b38e-e471-47fd-a276-37ce320118f0
```

> `9a66b38e-e471-47fd-a276-37ce320118f0` is the password of the certificate, you can change it to any password you want.
